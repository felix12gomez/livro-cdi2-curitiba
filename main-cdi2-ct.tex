...
\onehalfspacing
\thispagestyle{empty}
%\include{pagetitle-cdi2-ct}
\input{pagetitle-cdi2-ct}
\pagenumbering{roman}
%% here is the place to write your document's text
%\include{prefacio-cdi2-ct}
\input{prefacio-cdi2-ct}
% Table of contents
\tableofcontents
\cleardoublepage
%-------------------------------------------------------------------------
...
%-----------------------------------------------------------------------	
%% here is the place to write your document's text
\include{capitulos/cap1-cdi2-ct}
\include{capitulos/cap2-cdi2-ct}
\include{capitulos/cap3-cdi2-ct}
\include{capitulos/cap4-cdi2-ct}
\include{capitulos/cap5-cdi2-ct}	
\appendix
%
%\input{apendix01-cdi2-ct}
\include{apendix01-cdi2-ct}
\cleardoublepage
%
%\input{apendix02-cdi2-ct}
\include{apendix02-cdi2-ct}
\cleardoublepage
%
%\input{index-cdi2-ct}
